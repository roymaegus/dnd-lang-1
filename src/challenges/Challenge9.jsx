...
const SentenceBuilder9 = () => {
  const initialItems = [
    { id: 'item1', code: 'Le', hint: 'First word (indirect object pronoun)' },
    { id: 'item2', code: 'di', hint: 'Second word (verb)' },
    { id: 'item3', code: 'el', hint: 'Third word (article)' },
    { id: 'item4', code: 'libro', hint: 'Fourth word (direct object)' },
    { id: 'item5', code: 'a', hint: 'Fifth word (preposition)' },
    { id: 'item6', code: 'mi', hint: 'Sixth word (possessive adjective)' },
    { id: 'item7', code: 'hermano', hint: 'Seventh word (indirect object)' },
    { id: 'item8', code: 'ayer', hint: 'Eighth word (time adverb)' },
  ];
        ...
        <div className="columns-wrapper">
          <div className="columns-container">
            ...
            <div className="column">
              ...
              />
              {isCorrectOrder !== null && (
                <div>{isCorrectOrder ? 'Correct! The sentence is: Le di el libro a mi hermano ayer.' : 'Incorrect'}</div>
              )}
            </div>
          </div>
        </div>
...
export default SentenceBuilder9;
