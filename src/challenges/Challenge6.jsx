...
const SentenceBuilder6 = () => {
  const initialItems = [
    { id: 'item1', code: 'Si', hint: 'First word (conditional "if")' },
    { id: 'item2', code: 'tuviera', hint: 'Second word (verb in past subjunctive)' },
    { id: 'item3', code: 'dinero', hint: 'Third word (noun)' },
    { id: 'item4', code: 'compraría', hint: 'Fourth word (conditional verb)' },
    { id: 'item5', code: 'una', hint: 'Fifth word (article)' },
    { id: 'item6', code: 'casa', hint: 'Sixth word (noun)' },
    { id: 'item7', code: 'grande', hint: 'Seventh word (adjective)' },
  ];
        ...
        <div className="columns-wrapper">
          <div className="columns-container">
            ...
            <div className="column">
              ...
              />
              {isCorrectOrder !== null && (
                <div>{isCorrectOrder ? 'Correct! The sentence is: Si tuviera dinero, compraría una casa grande.' : 'Incorrect'}</div>
              )}
            </div>
          </div>
        </div>
...
export default SentenceBuilder6;
