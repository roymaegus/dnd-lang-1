        ...
        <div className="columns-wrapper">
          <div className="columns-container">
            ...
            <div className="column">
              ...
              />
              {isCorrectOrder !== null && (
                <div>{isCorrectOrder ? 'Correct! The sentence is: Yo quiero aprender español rápidamente.' : 'Incorrect'}</div>
              )}
            </div>
          </div>
        </div>
...
// const Challenge1 = () => {
//   const initialItems = [
//     { id: 'item1', code: 'function findVowels(word){', hint: 'Create a variable and assign the value of 1' },
//     { id: 'item2', code: 'let count = 0 //first var}', hint: 'Hint 2' },
//     { id: 'item3', code: 'const vowels = [\'a\', \'e\', \'i\', \'o\', \'u\']; //second var', hint: 'Hint 3' },
//     { id: 'item4', code: 'for (let i = 0; i < word.length; i++) {', hint: 'Hint 4' },
//     { id: 'item5', code: 'if (vowels.includes(word[i].toLowerCase())) {', hint: 'Hint 5' },
//     { id: 'item6', code: 'if (count++;) {', hint: 'Hint 6' },
//     { id: 'item7', code: '(} //end of if statement) {', hint: 'Hint 7' },
//     { id: 'item8', code: 'if (} //end of for loop) {', hint: 'Hint 8' },
//     { id: 'item9', code: 'return count) {', hint: 'Hint 9' },
//     { id: 'item10', code: '(}// End of findVowels function)', hint: 'Hint 10' },
//   ];
...
//               />
//               {isCorrectOrder !== null && (
//                 <div>{isCorrectOrder ? 'Correct' : 'Incorrect'}</div>
//               )}
//             </div>
//           </div>
//         </div>
