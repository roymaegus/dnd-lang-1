...
const SentenceBuilder10 = () => {
  const initialItems = [
    { id: 'item1', code: 'Mañana', hint: 'First word (time expression)' },
    { id: 'item2', code: 'le', hint: 'Second word (indirect object pronoun)' },
    { id: 'item3', code: 'voy', hint: 'Third word (verb, future tense)' },
    { id: 'item4', code: 'a', hint: 'Fourth word (preposition)' },
    { id: 'item5', code: 'dar', hint: 'Fifth word (infinitive verb)' },
    { id: 'item6', code: 'una', hint: 'Sixth word (article)' },
    { id: 'item7', code: 'respuesta', hint: 'Seventh word (direct object)' },
    { id: 'item8', code: 'a', hint: 'Eighth word (preposition)' },
    { id: 'item9', code: 'ella', hint: 'Ninth word (indirect object)' },
  ];
        ...
        <div className="columns-wrapper">
          <div className="columns-container">
            ...
            <div className="column">
              ...
              />
              {isCorrectOrder !== null && (
                <div>{isCorrectOrder ? 'Correct! The sentence is: Mañana le voy a dar una respuesta a ella.' : 'Incorrect'}</div>
              )}
            </div>
          </div>
        </div>
...
export default SentenceBuilder10;
