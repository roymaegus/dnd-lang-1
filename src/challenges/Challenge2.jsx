...
const SentenceBuilder2 = () => {
  const initialItems = [
    { id: 'item1', code: 'Ella', hint: 'First word (subject)' },
    { id: 'item2', code: 'está', hint: 'Second word (verb)' },
    { id: 'item3', code: 'muy', hint: 'Third word (adverb)' },
    { id: 'item4', code: 'feliz', hint: 'Fourth word (adjective)' },
    { id: 'item5', code: 'hoy', hint: 'Fifth word (time adverb)' },
  ];
        ...
        <div className="columns-wrapper">
          <div className="columns-container">
            ...
            <div className="column">
              ...
              />
              {isCorrectOrder !== null && (
                <div>{isCorrectOrder ? 'Correct! The sentence is: Ella está muy feliz hoy.' : 'Incorrect'}</div>
              )}
            </div>
          </div>
        </div>
...
export default SentenceBuilder2;
