...
const SentenceBuilder3 = () => {
  const initialItems = [
    { id: 'item1', code: '¿Dónde', hint: 'First word (interrogative)' },
    { id: 'item2', code: 'está', hint: 'Second word (verb)' },
    { id: 'item3', code: 'la', hint: 'Third word (article)' },
    { id: 'item4', code: 'biblioteca', hint: 'Fourth word (noun)' },
    { id: 'item5', code: '?', hint: 'Fifth item (question mark)' },
  ];
...
export default SentenceBuilder3;
