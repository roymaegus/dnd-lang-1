...
const SentenceBuilder5 = () => {
  const initialItems = [
    { id: 'item1', code: 'Mi', hint: 'First word (possessive adjective)' },
    { id: 'item2', code: 'amigo', hint: 'Second word (subject)' },
    { id: 'item3', code: 'me', hint: 'Third word (object pronoun)' },
    { id: 'item4', code: 'dio', hint: 'Fourth word (verb)' },
    { id: 'item5', code: 'un', hint: 'Fifth word (article)' },
    { id: 'item6', code: 'regalo', hint: 'Sixth word (direct object)' },
    { id: 'item7', code: 'ayer', hint: 'Seventh word (time adverb)' },
  ];
        ...
        <div className="columns-wrapper">
          <div className="columns-container">
            ...
            <div className="column">
              ...
              />
              {isCorrectOrder !== null && (
                <div>{isCorrectOrder ? 'Correct! The sentence is: Mi amigo me dio un regalo ayer.' : 'Incorrect'}</div>
              )}
            </div>
          </div>
        </div>
...
export default SentenceBuilder5;
